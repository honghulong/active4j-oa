...
public class ReflectHelper {
	...
	private Hashtable<String, Method> isMethods = null;
	...
	public void initMethods() {
		...
		isMethods = new Hashtable<String, Method>();
		cls = obj.getClass();
	...
	public boolean setMethodValue(String property,Object object) {
		...
		if (m != null) {
			try {
				...
				log.error("invoke getter on " + property + " error: " + ex.toString());
				return false;
			}
		}
		return false;
	...
	public Object getMethodValue(String property) {
		...
		if(m == null) {
			m = isMethods.get(property.toLowerCase());
		}
		if (m != null) {
			try {
				/**
