$(function() {
	...
	function xiao() {
		var o = $(this).attr("href"), m = $(this).data("index"), l = '启动流程', k = true;
		if (o == undefined || $.trim(o).length == 0) {
			return false
		}
		$(".J_menuTab").each(
	...
	function yang() {
		var o = $(this).attr("href"), m = $(this).data("index"), l = '浏览新闻', k = true;
		if (o == undefined || $.trim(o).length == 0) {
			return false
		}
		$(".J_menuTab").each(
	...
	function lei() {
		var o = $(this).attr("href"), m = $(this).data("index"), ccc=$(this).attr("urlId"), l = $.trim($(
				this).text()), k = true;
		if (o == undefined || $.trim(o).length == 0) {
			return false
		}
		
		var rowId = $('#' + ccc).jqGrid('getGridParam', 'selrow');
		if (!rowId) {
			qhAlert('请选择要编辑的项目');
			o += '&id=-1';
		}
	...
	$(".J_menuItem2").on("click", chen);
	$(".J_menuItem3").on("click", xiao);
	$(".J_menuItem4").on("click", lei);
	$(".J_menuItem5").on("click", yang);
	$(".J_menuItem6").on("click", feng);
	function h() {
